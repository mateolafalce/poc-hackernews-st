...
- title: a catchy title for the YouTube Short
- description: a brief description for the YouTube video
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": "You are a creative content creator specialized in making engaging YouTube Shorts scripts with a San Francisco Bay Area vibe. You always respond with valid JSON."
                },
                {
                    "role": "user",
                    "content": prompt
